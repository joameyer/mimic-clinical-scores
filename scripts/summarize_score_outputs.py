...
SCORES = {
    ...
    "saps_iii_adapted": {
        "total": "saps_iii_proxy_total_unvalidated",
        "probabilities": (
            "saps_iii_prob_global_proxy_unvalidated",
            "saps_iii_prob_north_america_proxy_unvalidated",
        ),
        "proxy_columns": (
            "complete_original_saps_iii_available",
            "mechanical_ventilation_at_gas_proxy",
            "vasoactive_preicu_proxy",
            "planned_icu_proxy",
            "diagnoses_are_posthoc_proxies",
            "planned_icu_original_available",
            "admission_reason_original_available",
            "surgery_planning_original_available",
            "surgical_site_original_available",
            "infection_acquisition_original_available",
            "nyha_iv_available",
