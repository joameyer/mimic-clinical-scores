...
RULES = {
    ...
    "mimiciv_icu.chartevents": StagingRule("mimiciv_icu.chartevents", "stay_id", "audited physiology/GCS/ventilation item IDs; inclusive [intime-1h, intime+1h], with FiO2 retained from intime-3h for exact 2h preceding gas context"),
    "mimiciv_hosp.labevents": StagingRule("mimiciv_hosp.labevents", "hadm_id", "audited laboratory item IDs; inclusive [intime-1h, intime+1h] for each selected stay"),
